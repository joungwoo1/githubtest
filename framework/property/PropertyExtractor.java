...
public class PropertyExtractor {
	...
	/**
	 * String 속성 중 @TargetProperty가 달린 값을 추출. Associated 속성까지 재귀적 탐색
	 * 
	 * @param obj
	 * @param ret
	 * @throws Exception
	...
	/*
	 * 활용 예시 public static void main(String[] args) { PostVO tgt = new PostVO();
	 * tgt.setTitle("null title"); tgt.setContent("null content"); MemberVO writer =
	 * new MemberVO("고길동", true); tgt.setWriter(writer);
	 * 
	 * List<String> rrr = extractProperty(tgt); for (String s : rrr) {
